...
(8, '2022_05_23_130604_create_stageaire_table', 5);
...
--
-- Table structure for table `stageaire`
--

CREATE TABLE `stageaire` (
  `id` bigint(20) UNSIGNED NOT NULL,
  ...
  `dateDebut` tinyint(1) NOT NULL,
  `dateFin` tinyint(1) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `stageaire`
--
ALTER TABLE `stageaire`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `stageaire`
--
ALTER TABLE `stageaire`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
